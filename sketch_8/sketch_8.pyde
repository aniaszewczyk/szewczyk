...
def setup():
    size(220,100)
    global library, Madzia, Anna
    books = ["Naocznosc", "Sens Sztuki", "Harry Potter", "Zbrodnia i kara"]
...
def mouseClicked():
    if mouseX >100 and mouseX<200:
        if mouseY >10 and mouseY <30:
            ...
            library.lendBook(Anna.requestBook("Zbrodnia i kara"))
        if mouseY >40 and mouseY <60:
            library.addBook(Madzia.returnBook())
            library.addBook(Anna.returnBook())
            
0,5/0,5 pkt za tę część
